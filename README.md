...
<picture>
  ...
  <img alt="System Context (Level 1)" src="docs/img/arch-level-1-light.png" width="100%">
</picture>

<picture>
  <source media="(prefers-color-scheme: dark)" srcset="docs/img/arch-level-2-dark.png">
  <img alt="Container Architecture (Level 2)" src="docs/img/arch-level-2-light.png" width="100%">
</picture>

<picture>
  <source media="(prefers-color-scheme: dark)" srcset="docs/img/arch-level-3-dark.png">
  <img alt="Component Architecture (Level 3)" src="docs/img/arch-level-3-light.png" width="100%">
</picture>
